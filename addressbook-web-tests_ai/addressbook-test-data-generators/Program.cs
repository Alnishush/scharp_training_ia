...
namespace addressbook_test_data_generators
{
    class Program
    {
        ...
        {
            int count = Convert.ToInt32(args[0]);               //количество генерируемых объектов
            StreamWriter writer = new StreamWriter(args[1]);    //имя файла
            string format = args[2];                            //формат
            string dataType = args[3];                          //тип данных groups или contacts
            ...
            else
            {
                ...
                Console.WriteLine("Use: groups | contacts");
            }
            writer.Close();
        }

        // Запись в файлы groups
